...
public class SampleKafkaApplicationTests {
	...
	public static class Config {
		...
		@Bean
		public PaymentConsumer consumer() {
			return new PaymentConsumer() {

				@Override
				public void processMessage(Payment payment, List<Integer> partitions,
										   List<String> topics,  List<Long> offsets) {
					super.processMessage(Payment.of(UUID.randomUUID().toString(), BigDecimal.TEN), partitions, topics, offsets);
					latch.countDown();
				}
